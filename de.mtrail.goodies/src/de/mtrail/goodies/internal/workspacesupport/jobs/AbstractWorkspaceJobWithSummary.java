 ...
 * <ul>
 * <li>holds access to a summary collector instance to provide summary information of this job during its execution.</li>
 * <li>Defines a mutex job rule to avoid parallel execution of the jobs.</li>
 * </ul>
 * <br>
 * Subclasses may erase the previously set jobrule to enable simultanous execution of the job. This can only be applied for jobs not
 * dependant on results of other jobs of this plugin.
 */
public abstract class AbstractWorkspaceJobWithSummary extends Job {
  ...
  public AbstractWorkspaceJobWithSummary(final String name, final SummaryCollector summaryCollector, final int priority) {
    super(name);
  ...
  /**
   * Must be implemented by subclass. The monitor must not be converted or in any other way being manipulated except by IDE actions/handlers
