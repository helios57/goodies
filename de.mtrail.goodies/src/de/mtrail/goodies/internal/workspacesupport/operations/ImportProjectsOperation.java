...
/**
 * This Operation is responsible to import all projects mentionened in the
 * workspace configuration file, but aren't imported yet into the workspace. Its
 * based on the {@link SmartImportJob}, which does *ALL* the work. This
 * operation simply compares the content of the workspace with the elements from
 * the workspace configuration file.
 * <p>
 * An {@link SummaryCollectorAdapter} will be injected to the
 * {@link SmartImportJob} to gain more information about progress and errors.
 */
...
public final class ImportProjectsOperation {
	 ...
	 *
	 * @param path                    a path to a file in the workspace or the path
	 *                                to the workspace directory (must end with a
	 *                                File.separator)
	 * @param workspaceConfiguration  the workspace configuration file
	 * @param summaryCollectorAdapter Collector for all status information presented
	 *                                to the user
	 * @param preferenceSupport       Goodies Preference Support for fine-tuning the
	 *                                import operation
	 */
