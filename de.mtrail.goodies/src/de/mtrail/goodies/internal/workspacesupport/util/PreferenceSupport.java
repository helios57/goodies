...
/**
 * This class is responsible to ensure properties required by the Goodies Bundle
 * are being set accordingly. This class will (in the near future) also handle
 * Eclipse specific settings which are benefitial for certain requirements
 * during Developement in RCS.
 */
