...
/**
 * A summary collector collects {@link Status} instances and allows to show
 * those whenever required. We misuse the ErrorDialog here, because it provides
 * the nifty fold-control to show excessive messages.
 */
