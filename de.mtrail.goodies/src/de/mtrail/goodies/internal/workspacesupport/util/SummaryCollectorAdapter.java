...
/**
 * The {@link SummaryCollectorAdapter} allows you to combine the Listening to
 * operational feedback from the {@link ImportProjectsOperation} while directly
 * reporting these feedbacks to the summary collector of the plugin.
 */
