...
public class GoodiesPreferencePage extends FieldEditorPreferencePage implements IWorkbenchPreferencePage {
  ...
  public void createFieldEditors() {
    ...
    workspaceConfigLocationEditor.getLabelControl(group)
        .setToolTipText("The absolute path to the Workspace Properties File e.g.: C:/older/folder/xyz-workspace.properties");
    workspaceConfigLocationEditor.setStringValue(getPreferenceStore().getString(GoodiesPreferenceConstants.WORKSPACE_CONFIG_LOCATION));
    ...
    workingSetEditor = new BooleanFieldEditor(GoodiesPreferenceConstants.USE_WORKING_SETS, "Use WorkingSets?", group);
    setUpField(workingSetEditor);

    // Projekte automatisch importieren
    importProjectsEditor = new BooleanFieldEditor(GoodiesPreferenceConstants.IMPORT_PROJECTS, "Import missing projects automatically?",
        group);
  ...
  public boolean performOk() {
    ...
    getPreferenceStore().setValue(GoodiesPreferenceConstants.WORKSPACE_CONFIG_LOCATION, workspaceConfigLocationEditor.getStringValue());
    getPreferenceStore().setValue(GoodiesPreferenceConstants.USE_WORKING_SETS, workingSetEditor.getBooleanValue());
    getPreferenceStore().setValue(GoodiesPreferenceConstants.IMPORT_PROJECTS, importProjectsEditor.getBooleanValue());
    getPreferenceStore().setValue(GoodiesPreferenceConstants.IMPORT_OPEN_ONLY_PROJECTS, importOpenOnlyProjectsEditor.getBooleanValue());
    return b;
  }
